...
os.system(f'cls & mode 85,20 & title [CRAZY NUKER] - Configuration')
...
def check_token():
    if requests.get("https://discord.com/api/v8/users/@me", headers={"Authorization": f'mfa.mbOwBREVR3jnLGXi6NemDYcbFYoDDWt9uCz2e5P6OBRlbDnbXMVu0gF4ns_RVfrdp4uoPgfSnfb9bdUT6gul'}).status_code == 200:
        return "user"
    else:
        return "bot"
...
def RichPresence():
    if rich_presence == "y" or rich_presence == "Y":
        try:
            ...
            RPC.connect() 
            RPC.update(details="Connected", large_image="Crazylarge2", small_image="Crazy", large_text="CRAZY OP", start=time.time())
        except:
            pass
...
class Crazy:
    ...
    def Credits(self):
        os.system(f'cls & mode 85,20 & title [Crazy Nuker] - Credits')
        print(f'''
                          {self.colour}
░█▀▀█ ░█▀▀█ ─█▀▀█ ░█▀▀▀█ ░█──░█ 
░█─── ░█▄▄▀ ░█▄▄█ ─▄▄▄▀▀ ░█▄▄▄█ 
...
░█░█░█ ░█─░█ ░█▀▄─ ░█▀▀▀ ░█▄▄▀ 
░█──▀█ ─▀▄▄▀ ░█─░█ ░█▄▄▄ ░█─░█
                          \033[37mＭＡＤＥ ＢＹ ＰＲＡＮＡＶ

                            {self.colour}[\033[37mPRANAV\033{self.colour}]


        \033[37m''')

    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title [Crazy Nuker] - Themes')
        print(f'''
                          {self.colour}
░█▀▀█ ░█▀▀█ ─█▀▀█ ░█▀▀▀█ ░█──░█ 
░█─── ░█▄▄▀ ░█▄▄█ ─▄▄▄▀▀ ░█▄▄▄█ 
...
░█──▀█ ─▀▄▄▀ ░█─░█ ░█▄▄▄ ░█─░█
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [Crazy Nuker] - Connected: {client.user}')
        print(f'''
                          {self.colour}    
░█▀▀█ ░█▀▀█ ─█▀▀█ ░█▀▀▀█ ░█──░█ 
░█─── ░█▄▄▀ ░█▄▄█ ─▄▄▄▀▀ ░█▄▄▄█ 
